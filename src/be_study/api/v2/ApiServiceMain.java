...
public class ApiServiceMain {
	...
	public static void main(String[] args) {
		...
		MidTaDTO midTaDTO = repository.getMidTa("202601160600", "11B10101");
		//202601160600 시간 기준, 11B10101 서울 날씨 
		
		//midTaDTO 활용
		System.out.println(midTaDTO);
		
		MidTaDTO midTaDTO2 = repository.getMidTa("202601160600", "11B20201");
		//202601160600 시간 기준, 11B20201 인천 날씨 
